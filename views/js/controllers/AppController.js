...
(function () {
    ...
    angular.module('KPIApp.controllers', [])
        .controller('AppController', function ($scope, $timeout, Service, EChartsFactory, uuid) {
            var vm = $scope.vm = {
                check: 0,
                selected: {},
                docks: [
            ...
            Service.getDataSource('json/GeoJSON.json').then(function (geoJson) {
                echarts.registerMap('LHK', geoJson);

                Service.getContent().then(function (dropzone) {
